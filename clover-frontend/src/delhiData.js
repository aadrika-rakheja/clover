...
window.CPCB_STATIONS = [
  { id: "ncr_gnoida_kp3", name: "Knowledge Park III, Greater Noida", district: "Gautam Buddha Nagar", lat: 28.4720, lon: 77.4890, type: "Institutional & Tech Corridor" },
  { id: "ncr_gnoida_pari_chowk", name: "Pari Chowk, Greater Noida", district: "Gautam Buddha Nagar", lat: 28.4650, lon: 77.5090, type: "Commercial Transit & Junction" },
  { id: "ncr_gnoida_sec1", name: "Sector 1, Greater Noida West", district: "Gautam Buddha Nagar", lat: 28.5830, lon: 77.4600, type: "Residential High-Rise Hub" },
  { id: "ncr_gnoida_kp5", name: "Knowledge Park V, Greater Noida", district: "Gautam Buddha Nagar", lat: 28.5980, lon: 77.4720, type: "Industrial & IT Zone" },
  { id: "ncr_noida_sec62", name: "Noida Sector 62, Gautam Buddha Nagar", district: "Gautam Buddha Nagar", lat: 28.6245, lon: 77.3578, type: "IT Park / Expressway Hub" },
  { id: "ncr_noida_sec1", name: "Noida Sector 1, Industrial", district: "Gautam Buddha Nagar", lat: 28.5898, lon: 77.3114, type: "Industrial / Commercial" },
  { id: "del_anand_vihar", name: "Anand Vihar, East Delhi", district: "East Delhi", lat: 28.6508, lon: 77.3152, type: "Industrial / Inter-State Transit" },
  { id: "del_punjabi_bagh", name: "Punjabi Bagh, West Delhi", district: "West Delhi", lat: 28.6740, lon: 77.1310, type: "Dense Urban / Ring Road" },
  { id: "del_ito", name: "ITO Junction, Central Delhi", district: "Central Delhi", lat: 28.6310, lon: 77.2410, type: "Heavy Traffic Intercept" },
  { id: "del_rk_puram", name: "R K Puram, South Delhi", district: "South Delhi", lat: 28.5630, lon: 77.1860, type: "Residential / Institutional" },
  { id: "del_dwarka_sec8", name: "Dwarka Sector 8, South West", district: "South West Delhi", lat: 28.5710, lon: 77.0690, type: "Suburban / Airport Corridor" },
  { id: "del_bawana", name: "Bawana Industrial Area, North", district: "North Delhi", lat: 28.7762, lon: 77.0510, type: "Heavy Industrial Zone" },
  { id: "del_jahangirpuri", name: "Jahangirpuri, North Delhi", district: "North Delhi", lat: 28.7328, lon: 77.1706, type: "Commercial / Res. Mixed" },
  { id: "del_okhla_ph2", name: "Okhla Phase 2, South East", district: "South East Delhi", lat: 28.5307, lon: 77.2713, type: "Industrial / Waste-to-Energy" },
  { id: "del_wazirpur", name: "Wazirpur Industrial Area", district: "North West Delhi", lat: 28.6998, lon: 77.1654, type: "Metals / Finishing Cluster" },
  { id: "del_mandir_marg", name: "Mandir Marg, New Delhi", district: "New Delhi", lat: 28.6364, lon: 77.1973, type: "Diplomatic / Low Density" },
  { id: "del_rohini", name: "Rohini Sector 16, North West", district: "North West Delhi", lat: 28.7325, lon: 77.1199, type: "Planned Residential" },
  { id: "del_shadipur", name: "Shadipur, West Central", district: "West Delhi", lat: 28.6515, lon: 77.1581, type: "Urban Industrial Rail" },
  { id: "ncr_gurugram_vikas", name: "Vikas Sadan, Gurugram", district: "Gurugram", lat: 28.4501, lon: 77.0264, type: "Urban Center / NH48" },
  { id: "ncr_gurugram_teri", name: "TERI Gram, Gwal Pahari", district: "Gurugram", lat: 28.4312, lon: 77.1511, type: "Aravalli Ridge Background" },
  { id: "ncr_ghaziabad_vasundhara", name: "Vasundhara, Ghaziabad", district: "Ghaziabad", lat: 28.6603, lon: 77.3573, type: "Dense Urban / Brick Kiln Path" },
  { id: "ncr_faridabad_sec16a", name: "Sector 16A, Faridabad", district: "Faridabad", lat: 28.4088, lon: 77.3178, type: "Industrial / Auto Corridor" }
];
